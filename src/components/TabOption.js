...
const TabOption = () => {
  ...
  return (
    <div >
        ...
        <p className='text-primary text-2xl font-semibold'>Hey there, I&apos; m Dheeraj Thakur </p>
        <p className='text-dark py-1'>A dedicated web developer with a passion for creating digital experiences that harmoniously balance functionality and aesthetics.</p>
        </div>
        <Tabs color="dark" defaultValue="education" className='border p-4 mb-2 hover:shadow-black	shadow-violet-500	 shadow-sm container mx-auto px-16 pb-16 '>
